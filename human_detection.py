...
# ✅ Embedded Google NLP Credentials (in-memory)
credentials_info = {
...
# ✅ Create the LanguageServiceClient using the in-memory credentials
...
# ✅ Example test
# text = "JOHN DOE 123 BANK STREET NEW YORK. Elon Musk is the CEO. Safe Driver Permit."
# print(extract_person_names(text))  # Should return "Elon Musk"
